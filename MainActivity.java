...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        fab = findViewById(R.id.change_user);
        ...
        repoButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(MainActivity.this,Activity_Repos.class);
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>()
        {
            ...
            public void onResponse(String response)
            {
                ...
                try
                {
                    ...
                    fpd.setFollowers("Followers: " + jsonObject.getString("followers"));
                    fpd.setFollowing("Following: " + jsonObject.getString("following"));
    ...
    void renderItems()
    {
        ...
        if(fpd.getEmail().toString() == "null")
        {
            ...
            {
                email.setText(fpd.getEmail().toString());
